...
const Page = async ({
    ...
    const filterObj = { name: name, lusters: lusters?.split(','), mineralClasses: mineralClasses?.split(','), crystalSystems: crystalSystems?.split(','), minHardness: Number(minHardness), maxHardness: Number(maxHardness) }
