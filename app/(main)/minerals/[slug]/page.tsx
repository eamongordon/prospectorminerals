...
export default async function Page({ params }: { params: { slug: string } }) {
    ...
    return (
        <main className="px-6 max-w-screen-xl mx-auto">
            ...
            <Gallery data={mineral.photos ? mineral.photos.map((obj) => {return {title: obj.photo.name ? obj.photo.name : undefined, caption: "Test Caption", image: obj.photo.image ? obj.photo.image : undefined}} ) : galleryData} />
