            ...
            <div className='px-6 max-w-screen-xl mx-auto space-y-6 my-6 sm:space-y-10 sm:my-10'>
                ...
                <div className='flex flex-col md:flex-row gap-4 md:gap-8'>
                    <div className='w-full md:w-2/3'>
                        <Gallery data={locality.photos.map((obj) => { return { title: obj.name ? obj.name : undefined, caption: obj.locality ? obj.locality.name : obj.locality_fallback || undefined, image: obj.image ? obj.image : undefined, blurDataURL: obj.imageBlurhash ? obj.imageBlurhash : undefined } })} />
                    </div>
