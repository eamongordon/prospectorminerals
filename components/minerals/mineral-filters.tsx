...
export default function MineralFilters({ name, lusters }: { name?: string, lusters?:string[] | undefined }) {
    ...
    */
    ...
    const [lustersVal, setLustersVal] = useState<String[]>(lusters ? lusters : []);
